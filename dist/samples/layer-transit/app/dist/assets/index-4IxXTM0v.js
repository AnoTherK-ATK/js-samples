 ...
 */function c(){const n=new google.maps.Map(document.getElementById("map"),{zoom:13,center:{lat:10.7602,lng:106.6993}});new google.maps.TransitLayer().setMap(n)}window.initMap=c;
