 ...
 */function c(){const i=new google.maps.Map(document.getElementById("map"),{zoom:14,center:{lat:10.7602,lng:106.6993}});new google.maps.BicyclingLayer().setMap(i)}window.initMap=c;
